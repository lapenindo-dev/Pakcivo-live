...
function normalizeForSpeech(text) {
  ...
  t = t.replace(/\bCivo\b/g, "Sivo");
  t = t.replace(/\bcivo\b/g, "Sivo");
  t = t.replace(/\bSamcanOn\b/gi, "Sam-chan On");
  t = t.replace(/\bSamcanOff\b/gi, "Sam-chan Off");
  t = t.replace(/\bSAMCAN ON\b/g, "Sam-chan On");
  t = t.replace(/\bSAMCAN OFF\b/g, "Sam-chan Off");
  t = t.replace(/\bSAMCAN\b/g, "Sam-chan");
